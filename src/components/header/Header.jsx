    ...
    return (
        <div className="header">
            <nav className="header__nav">
                <h1 className="header__titulo">WARG</h1>
                <div className="header__routes">
                    <ul className="header__routes-list">
                        <a className="header__routes-items" href="#"><FontAwesomeIcon icon={faTwitter} /></a>
            ...
            <div className="header__info">
                ...
                <p className="header__texto">Junior Frontend Developer</p>
            </div>
        </div>
    )
}
